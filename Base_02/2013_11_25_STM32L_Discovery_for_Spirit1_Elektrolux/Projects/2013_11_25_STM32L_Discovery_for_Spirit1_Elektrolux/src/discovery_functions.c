 /**
 ******************************************************************************
 * @file    discovery_functions.c
 * @author  Microcontroller Division
 * @version V1.0.3
 * @date    24 November 2013
 * @brief   Discovery demo functions
 ******************************************************************************
 * @copy
 *
...
void auto_test(void)
{
  ...
  // Switch OFF USer controlled LEDs
  GPIO_LOW(LED_GPIO_PORT,LED_GREEN_GPIO_PIN);	// LED #3 = Off
  GPIO_LOW(LED_GPIO_PORT,LED_BLUE_GPIO_PIN);    // LED #4 = Off
