...
#ifndef __DISCOVERY_BOARD_H
#define __DISCOVERY_BOARD_H
...
#define LED_GREEN_GPIO_PIN      GPIO_Pin_7   // LED #3
#define LED_BLUE_GPIO_PIN       GPIO_Pin_6   // LED #4
